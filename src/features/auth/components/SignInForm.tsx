...
export default function SignInForm() {
    ...
    return (
        <div>
            ...
            <p className="text-sm text-neutral-600 leading-relaxed">Don&apos;t have an account ? <Link className="underline underline-offset-4 text-blue-500 hover:text-blue-600" href="/sign-up">Sign up</Link> here</p>
        </div>
    )
}